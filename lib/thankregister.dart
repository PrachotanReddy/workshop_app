...
import 'package:workshop_app/welcome_screen.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            RoundedButton(onPressed:(){Navigator.pushReplacementNamed(context, WelcomeScreen.id);},title:'Back to Home',colour: Colors.blue),
          ],
        ),
      ),
    );
